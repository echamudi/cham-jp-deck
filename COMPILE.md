...
```
mkdir -p dist
csvtojson --delimiter="\t" --noheader="true" --headers="[\"empty\",\"char\",\"strokes\",\"composition_kind\",\"first\",\"first_strokes\",\"second\",\"second_strokes\",\"cangjie_coding\",\"notes\",\"radical\"]" ./source/CCD.csv > ./dist/CCD.json
